...
<head>
    ...
    <title>Fitzone</title>
    <link rel="icon" href="{{asset('fronend/img/favicon.png')}}">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/bootstrap.min.css')}}">
    <!-- animate CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/animate.css')}}">
    <!-- owl carousel CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/owl.carousel.min.css')}}">
    <!-- themify CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/themify-icons.css')}}">
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/flaticon.css')}}">
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/magnific-popup.css')}}">
    <!-- swiper CSS -->
    <link rel="stylesheet" href="{{asset('fronend/css/all.css')}}">
    <!-- style CSS -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="index.html"> <img src="{{asset('fronend/img/logo.png')}}" alt="logo"> </a>
...
<section class="about_us section_padding">
    <div class="container">
        ...
        <div class="row justify-content-between">
                ...
                <div class="our_feature">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="single_feature_item">
                                <div class="feature_item_icon">
                                    <span> <img src="{{asset('fronend/img/icon/icon.svg')}}" alt="icon"> </span>
                                </div>
            ...
            <div class="col-lg-4">
                <div class="about_img">
                    <img src="{{asset('fronend/img/about_bg.png')}}" alt="#">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="our_feature">
    ...
    <div class="overlay_icon">
        <img src="{{asset('fronend/img/animate_icon/icon_1.png')}}" class="amitated_icon_1" alt="animate_icon">
        <img src="{{asset('fronend/img/animate_icon/icon_2.png')}}" class="amitated_icon_2" alt="animate_icon">
        <img src="{{asset('fronend/img/animate_icon/icon_3.png')}}" class="amitated_icon_3" alt="animate_icon">
        <img src="{{asset('fronend/img/animate_icon/icon_4.png')}}" class="amitated_icon_4" alt="animate_icon">
        <img src="{{asset('fronend/img/animate_icon/icon_5.png')}}" class="amitated_icon_5" alt="animate_icon">
    </div>
</section>
        ...
        <div class="row ">
            <div class="col-lg-5">
                <div class="extends_img">
                    <img src="{{asset('fronend/img/excuses_video_bg.png')}}" alt="">
            ...
            <div class="col-lg-12">
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{asset('fronend/img/offer_img_1.png')}}" alt="offer_img_1">
                ...
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{asset('fronend/img/offer_img_2.png')}}" alt="offer_img_1">
                        <div class="hover_text">
                            <h2>Fitness Training</h2>
                            <p>Fly replenish dominion evening make veriety of </p>
                            <a href="#" class="offer_btn"><span class="flaticon-slim-right"></span></a>
                ...
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{asset('fronend/img/offer_img_3.png')}}" alt="offer_img_1">
                        <div class="hover_text">
                            <h2>Fitness Training</h2>
                            <p>Fly replenish dominion evening make veriety of </p>
                            <a href="#" class="offer_btn"><span class="flaticon-slim-right"></span></a>
                ...
                <div class="single_offer_part">
                    <div class="single_offer">
                        <img src="{{asset('fronend/img/offer_img_4.png')}}" alt="offer_img_1">
                        <div class="hover_text">
                            <h2>Fitness Training</h2>
                            <p>Fly replenish dominion evening make veriety of </p>
                            <a href="#" class="offer_btn"><span class="flaticon-slim-right"></span></a>
...
<section class="review_part gray_bg section_padding">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="client_img align-self-center">
                                    <img src="{{asset('fronend/img/client/client_1.png')}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="client_review_text media-body">
                                    ...
                                    <div class="star_icon">
                                        <a href="#"> <img src="{{asset('fronend/img/icon/star_1.svg')}}" alt=""> </a>
                                        <a href="#"> <img src="{{asset('fronend/img/icon/star_1.svg')}}" alt=""> </a>
                                        <a href="#"> <img src="{{asset('fronend/img/icon/star_1.svg')}}" alt=""> </a>
                                        <a href="#"> <img src="{{asset('fronend/img/icon/star_1.svg')}}" alt=""> </a>
                                        <a href="#"> <img src="{{asset('fronend/img/icon/star_2.svg')}}" alt=""> </a>
                                    </div>
    ...
    <div class="overlay_icon">
        <img src="{{asset('fronend/img/animate_icon/icon_6.png')}}" class="amitated_icon_6" alt="animate_icon">
    </div>
</section>
<!--::review_part end::-->
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="single_blog_item">
                    <div class="single_blog_img">
                        <img src="{{asset('fronend/img/team/team_1.png')}}" alt="">
...
<!-- jquery plugins here-->
<!-- jquery -->
<script src="{{asset('fronend/js/jquery-1.12.1.min.js')}}"></script>
<!-- popper js -->
<script src="{{asset('fronend/js/popper.min.js')}}"></script>
<!-- bootstrap js -->
<script src="{{asset('fronend/js/bootstrap.min.js')}}"></script>
<!-- easing js -->
<script src="{{asset('fronend/js/jquery.magnific-popup.js')}}"></script>
<!-- swiper js -->
<script src="{{asset('fronend/js/swiper.min.js')}}"></script>
<!-- swiper js -->
<script src="{{asset('fronend/js/masonry.pkgd.js')}}"></script>
<!-- particles js -->
<script src="{{asset('fronend/js/owl.carousel.min.js')}}"></script>
<!-- swiper js -->
<script src="{{asset('fronend/js/slick.min.js')}}"></script>
<script src="{{asset('fronend/js/gijgo.min.js')}}"></script>
<script src="{{asset('fronend/js/jquery.nice-select.min.js')}}"></script>
<!-- custom js -->
